    ...
    <div style="width: 70%; margin: 10px auto">
      ...
      <div style="margin: 30px 0; display: flex; grid-gap: 20px; min-height: 400px">
        ...
        <div style="flex: 1">
          ...
          <div>
            <div v-for="item in tableData" :key="item.id" class="card" style="display: flex; margin-bottom: 10px">
        ...
        <div style="width: 260px">
          ...
          <div class="card">
            <div @click="$router.push('/front/activityDetail?id=' + item.id)" style="display: flex; grid-gap: 10px; margin-bottom: 15px; cursor: pointer" v-for="item in activityList" :key="item.id">
