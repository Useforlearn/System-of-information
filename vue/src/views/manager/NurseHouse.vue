<template>
  <div>
    ...
    <el-dialog name="信息" :visible.sync="fromVisible" width="50%" :close-on-click-modal="false" destroy-on-close>
    ...
    <el-dialog title="内容详情" :visible.sync="fromVisible1" width="50%" :close-on-click-modal="false" destroy-on-close>
      <div class="w-e-text">
  ...
  methods: {
    ...
    save() {   // 保存按钮触发的逻辑  它会触发新增或者更新
      this.$refs.formRef.validate((valid) => {
        if (valid) {
          this.form.tags = JSON.stringify(this.tags) //数组转换成JSON字符串
